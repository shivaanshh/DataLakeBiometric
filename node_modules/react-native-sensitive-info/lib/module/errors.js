 ...
 */
export function toSensitiveInfoError(error) {
 ...
 */
export const isNotFoundError = error => error instanceof NotFoundError || extractCode(error) === ErrorCode.NotFound;
 ...
 */
export const isAuthenticationCanceledError = error => error instanceof AuthenticationCanceledError || extractCode(error) === ErrorCode.AuthenticationCanceled;
 ...
 */
export const isIntegrityViolationError = error => error instanceof IntegrityViolationError || extractCode(error) === ErrorCode.IntegrityViolation;
 ...
 */
export const isKeyInvalidatedError = error => error instanceof KeyInvalidatedError || extractCode(error) === ErrorCode.KeyInvalidated;
 ...
 */
export const isRotationFailedError = error => error instanceof RotationFailedError || extractCode(error) === ErrorCode.RotationFailed;
 ...
 */
export const isInvalidArgumentError = error => error instanceof InvalidArgumentError || extractCode(error) === ErrorCode.InvalidArgument;
