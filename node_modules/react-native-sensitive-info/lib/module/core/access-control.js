...
import { getSupportedSecurityLevels } from "./storage.js";
...
const POLICY_PREDICATES = {
  secureEnclaveBiometry: l => (l.secureEnclave || l.strongBox) && l.biometryStatus === 'available',
 ...
 * @public
 */
export function canUseAccessControlSync(policy, levels) {
 ...
 * @public
 */
export async function canUseAccessControl(policy, levels) {
