...
export const DEFAULT_ACCESS_CONTROL = 'secureEnclaveBiometry';
...
export function normalizeStorageScopeOptions(options) {
  const normalized = {
    service: options?.service ?? DEFAULT_SERVICE
  };
  if (options?.iosSynchronizable !== undefined) {
...
export function normalizePromptedReadOptions(options) {
