 ...
 */
export { canUseAccessControl, canUseAccessControlSync, } from './core/access-control';
export { clearService, deleteItem, getAllItems, getItem, getKeyVersion, getSupportedSecurityLevels, hasItem, rotateKeys, SensitiveInfo, type SensitiveInfoApi, setItem, } from './core/storage';
export { AuthenticationCanceledError, ErrorCode, type ErrorCodeValue, IntegrityViolationError, InvalidArgumentError, isAuthenticationCanceledError, isIntegrityViolationError, isInvalidArgumentError, isKeyInvalidatedError, isNotFoundError, isRotationFailedError, KeyInvalidatedError, NotFoundError, RotationFailedError, SensitiveInfoError, } from './errors';
export type { AccessControl, AuthenticationPrompt, BiometryStatus, MutationResult, RotateKeysRequest, RotationResult, SecurityAvailability, SecurityLevel, SensitiveInfo as SensitiveInfoModule, SensitiveInfoDeleteRequest, SensitiveInfoEnumerateRequest, SensitiveInfoGetRequest, SensitiveInfoHasRequest, SensitiveInfoItem, SensitiveInfoOptions, SensitiveInfoSetRequest, SensitiveInfoSpec, StorageBackend, StorageMetadata, } from './sensitive-info.nitro';
