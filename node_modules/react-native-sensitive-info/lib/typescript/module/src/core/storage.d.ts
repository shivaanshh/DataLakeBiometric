import type { MutationResult, RotateKeysRequest, RotationResult, SecurityAvailability, SensitiveInfoEnumerateRequest, SensitiveInfoItem, SensitiveInfoOptions } from '../sensitive-info.nitro';
/**
 ...
 */
export declare function setItem(key: string, value: string, options?: SensitiveInfoOptions): Promise<MutationResult>;
/**
 ...
 */
export declare function getItem(key: string, options?: SensitiveInfoOptions & {
 ...
 */
export declare function hasItem(key: string, options?: SensitiveInfoOptions): Promise<boolean>;
/**
 ...
 */
export declare function deleteItem(key: string, options?: SensitiveInfoOptions): Promise<boolean>;
/**
 ...
 */
export declare function getAllItems(options?: SensitiveInfoEnumerateRequest): Promise<SensitiveInfoItem[]>;
/**
 ...
 * ```
 */
export declare function clearService(options?: SensitiveInfoOptions): Promise<void>;
/**
 ...
 */
export declare function getSupportedSecurityLevels(): Promise<SecurityAvailability>;
/**
 ...
 */
export declare function rotateKeys(options?: RotateKeysRequest): Promise<RotationResult>;
/**
 ...
 * @see {@link rotateKeys}
 */
export declare function getKeyVersion(options?: SensitiveInfoOptions): Promise<number>;
/**
 ...
 */
export declare const SensitiveInfo: SensitiveInfoApi;
