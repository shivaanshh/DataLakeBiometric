...
export interface StorageMetadata {
     ...
     */
    readonly backend: 'keychain' | 'androidKeystore' | 'encryptedSharedPreferences';
    /**
 ...
 * ```
 */
export declare class SensitiveInfoError extends Error {
    /**
     ...
     * ```
     */
    constructor(code: ErrorCode | string, message: string, nativeError?: unknown);
}
/**
 ...
 * ```
 */
export declare function isSensitiveInfoError(error: unknown): error is SensitiveInfoError;
/**
 ...
 * @default 'secureEnclaveBiometry'
 */
export declare const DEFAULT_ACCESS_CONTROL: AccessControl;
/**
 * Supported platforms
 *
 * @example
 ...
 * ```
 */
export declare const SUPPORTED_PLATFORMS: readonly ["iOS", "macOS", "visionOS", "watchOS", "Android"];
/**
...
export declare const MIN_VERSIONS: {
    readonly iOS: "13.0";
    readonly macOS: "10.15";
    readonly visionOS: "1.0";
    readonly watchOS: "6.0";
    readonly Android: "8";
};
/**
 ...
 * @default 'default'
 */
export declare const DEFAULT_KEYCHAIN_SERVICE = "default";
