 ...
 */
import type { DeviceCapabilities, OperationResult, RetrievalOptions, StorageOptions } from './types';
export type { AccessControl, AuthenticationPrompt, SecurityLevel, StorageMetadata, DeviceCapabilities, StorageOptions, RetrievalOptions, OperationResult, StoredItem, } from './types';
export { SensitiveInfoError, ErrorCode, isSensitiveInfoError, SUPPORTED_PLATFORMS, MIN_VERSIONS, DEFAULT_ACCESS_CONTROL, DEFAULT_KEYCHAIN_SERVICE, MAX_VALUE_LENGTH, } from './types';
/**
 ...
 * ```
 */
export declare function setItem(key: string, value: string, options?: StorageOptions): Promise<OperationResult>;
/**
 ...
 * ```
 */
export declare function getItem(key: string, options?: RetrievalOptions): Promise<string | null>;
/**
 ...
 * ```
 */
export declare function hasItem(key: string, options?: Pick<StorageOptions, 'keychainService'>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function deleteItem(key: string, options?: Pick<StorageOptions, 'keychainService'>): Promise<void>;
/**
 ...
 * ```
 */
export declare function getAllItems(options?: Pick<StorageOptions, 'keychainService'>): Promise<string[]>;
/**
 ...
 * ```
 */
export declare function clearService(options?: Pick<StorageOptions, 'keychainService'>): Promise<void>;
/**
 ...
 * ```
 */
export declare function getSupportedSecurityLevels(): Promise<DeviceCapabilities>;
/**
 ...
 * ```
 */
export declare const SensitiveInfo: {
    setItem: typeof setItem;
    getItem: typeof getItem;
    hasItem: typeof hasItem;
    deleteItem: typeof deleteItem;
    getAllItems: typeof getAllItems;
    clearService: typeof clearService;
    getSupportedSecurityLevels: typeof getSupportedSecurityLevels;
};
