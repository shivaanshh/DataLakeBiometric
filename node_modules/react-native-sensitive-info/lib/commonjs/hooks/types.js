...
exports.createHookFailureResult = createHookFailureResult;
exports.createHookSuccessResult = createHookSuccessResult;
exports.createInitialAsyncState = createInitialAsyncState;
exports.createInitialVoidState = createInitialVoidState;
/**
 ...
 * ```
 */
function createInitialVoidState() {
  return {
    error: null,
    isLoading: false,
    isPending: false
 ...
 */
function createHookSuccessResult() {
  return {
    success: true
  };
}
 ...
 */
function createHookFailureResult(error) {
  return {
    success: false,
    error
  };
