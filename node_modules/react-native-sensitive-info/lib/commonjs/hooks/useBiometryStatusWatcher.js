...
exports.useBiometryStatusWatcher = useBiometryStatusWatcher;
var _compilerRuntime = require("react/compiler-runtime");
var _react = require("react");
var _useSecurityAvailability = require("./useSecurityAvailability.js");
/**
 ...
 * @public
 */
function useBiometryStatusWatcher(onChange) {
  ...
  const result = (0, _useSecurityAvailability.useSecurityAvailability)(t0);
  const listenerRef = (0, _react.useRef)(onChange);
  let t1;
  let t2;
  if ($[1] !== onChange) {
    t1 = () => {
