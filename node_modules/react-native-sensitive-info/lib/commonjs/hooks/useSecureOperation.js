...
exports.useSecureOperation = useSecureOperation;
var _compilerRuntime = require("react/compiler-runtime");
var _react = require("react");
var _useMutation = _interopRequireDefault(require("./useMutation.js"));
...
function useSecureOperation() {
  ...
  const {
    ...
    isPending,
    mutate
  } = (0, _useMutation.default)("useSecureOperation.execute", "Review the async callback passed to execute() for thrown errors.");
  let t0;
  if ($[0] !== mutate) {
    t0 = async operation => {
