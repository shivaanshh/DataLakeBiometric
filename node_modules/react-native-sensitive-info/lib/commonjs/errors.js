...
exports.isRotationFailedError = exports.isNotFoundError = exports.isKeyInvalidatedError = exports.isInvalidArgumentError = exports.isIntegrityViolationError = exports.isAuthenticationCanceledError = exports.SensitiveInfoError = exports.RotationFailedError = exports.NotFoundError = exports.KeyInvalidatedError = exports.InvalidArgumentError = exports.IntegrityViolationError = exports.ErrorCode = exports.AuthenticationCanceledError = void 0;
exports.toSensitiveInfoError = toSensitiveInfoError;
/**
 * # Typed errors
 *
 ...
 */
exports.SensitiveInfoError = SensitiveInfoError;
/**
 ...
 * ```
 */
class NotFoundError extends SensitiveInfoError {
  /**
   * @param message - Defaults to `'Secret not found.'`.
   * @param options - Optional `cause` for error chaining.
   */
  constructor(message = 'Secret not found.', options) {
...
class AuthenticationCanceledError extends SensitiveInfoError {
  /**
   * @param message - Defaults to `'Authentication prompt canceled by the user.'`.
   * @param options - Optional `cause` for error chaining.
   */
  constructor(message = 'Authentication prompt canceled by the user.', options) {
 ...
 * ```
 */
exports.AuthenticationCanceledError = AuthenticationCanceledError;
class IntegrityViolationError extends SensitiveInfoError {
   ...
   */
  constructor(message = 'Integrity check failed for stored secret.', options) {
...
class KeyInvalidatedError extends SensitiveInfoError {
   ...
   */
  constructor(message = 'The hardware key backing this entry was permanently invalidated.', options) {
...
class RotationFailedError extends SensitiveInfoError {
  /**
   * @param message - Defaults to `'Key rotation failed.'`.
   * @param options - Optional `cause` for error chaining.
   */
  constructor(message = 'Key rotation failed.', options) {
 ...
 * ```
 */
exports.RotationFailedError = RotationFailedError;
class InvalidArgumentError extends SensitiveInfoError {
   ...
   */
  constructor(message = 'Invalid argument supplied to secure storage.', options) {
...
const MARKER_TO_CODE = [['[E_NOT_FOUND]', ErrorCode.NotFound], ['[E_AUTH_CANCELED]', ErrorCode.AuthenticationCanceled], ['[E_INTEGRITY_VIOLATION]', ErrorCode.IntegrityViolation], ['[E_KEY_INVALIDATED]', ErrorCode.KeyInvalidated], ['[E_ROTATION_FAILED]', ErrorCode.RotationFailed], ['[E_INVALID_ARGUMENT]', ErrorCode.InvalidArgument]];
 ...
 */
function toSensitiveInfoError(error) {
  ...
  switch (code) {
    ...
    case ErrorCode.AuthenticationCanceled:
      return new AuthenticationCanceledError(message, {
        cause: error
      });
    case ErrorCode.IntegrityViolation:
      return new IntegrityViolationError(message, {
        cause: error
      });
    case ErrorCode.KeyInvalidated:
      return new KeyInvalidatedError(message, {
        cause: error
      });
    case ErrorCode.RotationFailed:
      return new RotationFailedError(message, {
        cause: error
      });
 ...
 */
const isNotFoundError = error => error instanceof NotFoundError || extractCode(error) === ErrorCode.NotFound;
...
const isAuthenticationCanceledError = error => error instanceof AuthenticationCanceledError || extractCode(error) === ErrorCode.AuthenticationCanceled;
 ...
 */
exports.isAuthenticationCanceledError = isAuthenticationCanceledError;
const isIntegrityViolationError = error => error instanceof IntegrityViolationError || extractCode(error) === ErrorCode.IntegrityViolation;
 ...
 */
exports.isIntegrityViolationError = isIntegrityViolationError;
const isKeyInvalidatedError = error => error instanceof KeyInvalidatedError || extractCode(error) === ErrorCode.KeyInvalidated;
 ...
 */
exports.isKeyInvalidatedError = isKeyInvalidatedError;
const isRotationFailedError = error => error instanceof RotationFailedError || extractCode(error) === ErrorCode.RotationFailed;
 ...
 */
exports.isRotationFailedError = isRotationFailedError;
const isInvalidArgumentError = error => error instanceof InvalidArgumentError || extractCode(error) === ErrorCode.InvalidArgument;
exports.isInvalidArgumentError = isInvalidArgumentError;
