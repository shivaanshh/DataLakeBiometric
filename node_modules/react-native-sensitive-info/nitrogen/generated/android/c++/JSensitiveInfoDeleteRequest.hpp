///
/// JSensitiveInfoDeleteRequest.hpp
...
namespace margelo::nitro::sensitiveinfo {
  ...
  /**
   * The C++ JNI bridge between the C++ struct "SensitiveInfoDeleteRequest" and the the Kotlin data class "SensitiveInfoDeleteRequest".
   */
  struct JSensitiveInfoDeleteRequest final: public jni::JavaClass<JSensitiveInfoDeleteRequest> {
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/sensitiveinfo/SensitiveInfoDeleteRequest;";

  public:
    /**
     * Convert this Java/Kotlin-based struct to the C++ struct SensitiveInfoDeleteRequest by copying all values to C++.
     */
    [[maybe_unused]]
    [[nodiscard]]
    SensitiveInfoDeleteRequest toCpp() const {
      ...
      return SensitiveInfoDeleteRequest(
        key->toStdString(),
  ...
  public:
     ...
     */
    [[maybe_unused]]
    static jni::local_ref<JSensitiveInfoDeleteRequest::javaobject> fromCpp(const SensitiveInfoDeleteRequest& value) {
      using JSignature = JSensitiveInfoDeleteRequest(jni::alias_ref<jni::JString>, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JBoolean>, jni::alias_ref<jni::JString>, jni::alias_ref<JAccessControl>, jni::alias_ref<JAuthenticationPrompt>);
      static const auto clazz = javaClassStatic();
