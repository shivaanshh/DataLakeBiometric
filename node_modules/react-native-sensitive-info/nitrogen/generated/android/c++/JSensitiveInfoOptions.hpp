...
namespace margelo::nitro::sensitiveinfo {
  ...
  /**
   * The C++ JNI bridge between the C++ struct "SensitiveInfoOptions" and the the Kotlin data class "SensitiveInfoOptions".
   */
  struct JSensitiveInfoOptions final: public jni::JavaClass<JSensitiveInfoOptions> {
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/sensitiveinfo/SensitiveInfoOptions;";

  public:
    /**
     * Convert this Java/Kotlin-based struct to the C++ struct SensitiveInfoOptions by copying all values to C++.
     */
    [[maybe_unused]]
    [[nodiscard]]
    SensitiveInfoOptions toCpp() const {
  ...
  public:
     ...
     */
    [[maybe_unused]]
    static jni::local_ref<JSensitiveInfoOptions::javaobject> fromCpp(const SensitiveInfoOptions& value) {
      using JSignature = JSensitiveInfoOptions(jni::alias_ref<jni::JString>, jni::alias_ref<jni::JBoolean>, jni::alias_ref<jni::JString>, jni::alias_ref<JAccessControl>, jni::alias_ref<JAuthenticationPrompt>);
      static const auto clazz = javaClassStatic();
