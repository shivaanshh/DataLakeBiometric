...
namespace margelo::nitro::sensitiveinfo {
  ...
  /**
   * The C++ JNI bridge between the C++ struct "RotateKeysRequest" and the the Kotlin data class "RotateKeysRequest".
   */
  struct JRotateKeysRequest final: public jni::JavaClass<JRotateKeysRequest> {
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/sensitiveinfo/RotateKeysRequest;";

  public:
    /**
     * Convert this Java/Kotlin-based struct to the C++ struct RotateKeysRequest by copying all values to C++.
     */
    [[maybe_unused]]
    [[nodiscard]]
    RotateKeysRequest toCpp() const {
      static const auto clazz = javaClassStatic();
      static const auto fieldReEncryptEagerly = clazz->getField<jni::JBoolean>("reEncryptEagerly");
      jni::local_ref<jni::JBoolean> reEncryptEagerly = this->getFieldValue(fieldReEncryptEagerly);
      ...
      return RotateKeysRequest(
        reEncryptEagerly != nullptr ? std::make_optional(static_cast<bool>(reEncryptEagerly->value())) : std::nullopt,
  ...
  public:
     ...
     */
    [[maybe_unused]]
    static jni::local_ref<JRotateKeysRequest::javaobject> fromCpp(const RotateKeysRequest& value) {
      using JSignature = JRotateKeysRequest(jni::alias_ref<jni::JBoolean>, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JBoolean>, jni::alias_ref<jni::JString>, jni::alias_ref<JAccessControl>, jni::alias_ref<JAuthenticationPrompt>);
      static const auto clazz = javaClassStatic();
      static const auto create = clazz->getStaticMethod<JSignature>("fromCpp");
      return create(
        clazz,
        value.reEncryptEagerly.has_value() ? jni::JBoolean::valueOf(value.reEncryptEagerly.value()) : nullptr,
