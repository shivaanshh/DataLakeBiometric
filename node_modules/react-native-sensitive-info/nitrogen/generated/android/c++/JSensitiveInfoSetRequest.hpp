...
namespace margelo::nitro::sensitiveinfo {
  ...
  /**
   * The C++ JNI bridge between the C++ struct "SensitiveInfoSetRequest" and the the Kotlin data class "SensitiveInfoSetRequest".
   */
  struct JSensitiveInfoSetRequest final: public jni::JavaClass<JSensitiveInfoSetRequest> {
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/sensitiveinfo/SensitiveInfoSetRequest;";

  public:
    /**
     * Convert this Java/Kotlin-based struct to the C++ struct SensitiveInfoSetRequest by copying all values to C++.
     */
    [[maybe_unused]]
    [[nodiscard]]
    SensitiveInfoSetRequest toCpp() const {
      ...
      return SensitiveInfoSetRequest(
        key->toStdString(),
        value->toStdString(),
  ...
  public:
     ...
     */
    [[maybe_unused]]
    static jni::local_ref<JSensitiveInfoSetRequest::javaobject> fromCpp(const SensitiveInfoSetRequest& value) {
      using JSignature = JSensitiveInfoSetRequest(jni::alias_ref<jni::JString>, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JBoolean>, jni::alias_ref<jni::JString>, jni::alias_ref<JAccessControl>, jni::alias_ref<JAuthenticationPrompt>);
      static const auto clazz = javaClassStatic();
