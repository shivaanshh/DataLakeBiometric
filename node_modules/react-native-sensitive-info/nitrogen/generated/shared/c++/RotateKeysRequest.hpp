...
namespace margelo::nitro::sensitiveinfo {
  ...
  /**
   * A struct which can be represented as a JavaScript object (RotateKeysRequest).
   */
  struct RotateKeysRequest final {
  public:
    std::optional<bool> reEncryptEagerly     SWIFT_PRIVATE;
  ...
  public:
    RotateKeysRequest() = default;
    explicit RotateKeysRequest(std::optional<bool> reEncryptEagerly, std::optional<std::string> service, std::optional<bool> iosSynchronizable, std::optional<std::string> keychainGroup, std::optional<AccessControl> accessControl, std::optional<AuthenticationPrompt> authenticationPrompt): reEncryptEagerly(reEncryptEagerly), service(service), iosSynchronizable(iosSynchronizable), keychainGroup(keychainGroup), accessControl(accessControl), authenticationPrompt(authenticationPrompt) {}

  public:
    friend bool operator==(const RotateKeysRequest& lhs, const RotateKeysRequest& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ RotateKeysRequest <> JS RotateKeysRequest (object)
  template <>
  struct JSIConverter<margelo::nitro::sensitiveinfo::RotateKeysRequest> final {
    static inline margelo::nitro::sensitiveinfo::RotateKeysRequest fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::sensitiveinfo::RotateKeysRequest(
        JSIConverter<std::optional<bool>>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "reEncryptEagerly"))),
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::sensitiveinfo::RotateKeysRequest& arg) {
      jsi::Object obj(runtime);
      obj.setProperty(runtime, PropNameIDCache::get(runtime, "reEncryptEagerly"), JSIConverter<std::optional<bool>>::toJSI(runtime, arg.reEncryptEagerly));
    ...
    static inline bool canConvert(jsi::Runtime& runtime, const jsi::Value& value) {
      ...
      if (!JSIConverter<std::optional<bool>>::canConvert(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "reEncryptEagerly")))) return false;
