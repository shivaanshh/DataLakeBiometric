...
namespace margelo::nitro::sensitiveinfo {
  ...
  /**
   * A struct which can be represented as a JavaScript object (SensitiveInfoHasRequest).
   */
  struct SensitiveInfoHasRequest final {
  public:
  ...
  public:
    SensitiveInfoHasRequest() = default;
    explicit SensitiveInfoHasRequest(std::string key, std::optional<std::string> service, std::optional<bool> iosSynchronizable, std::optional<std::string> keychainGroup, std::optional<AccessControl> accessControl, std::optional<AuthenticationPrompt> authenticationPrompt): key(key), service(service), iosSynchronizable(iosSynchronizable), keychainGroup(keychainGroup), accessControl(accessControl), authenticationPrompt(authenticationPrompt) {}

  public:
    friend bool operator==(const SensitiveInfoHasRequest& lhs, const SensitiveInfoHasRequest& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ SensitiveInfoHasRequest <> JS SensitiveInfoHasRequest (object)
  template <>
  struct JSIConverter<margelo::nitro::sensitiveinfo::SensitiveInfoHasRequest> final {
    static inline margelo::nitro::sensitiveinfo::SensitiveInfoHasRequest fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::sensitiveinfo::SensitiveInfoHasRequest(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::sensitiveinfo::SensitiveInfoHasRequest& arg) {
