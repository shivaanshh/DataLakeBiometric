///
/// SensitiveInfoEnumerateRequest.hpp
...
namespace margelo::nitro::sensitiveinfo {
  ...
  /**
   * A struct which can be represented as a JavaScript object (SensitiveInfoEnumerateRequest).
   */
  struct SensitiveInfoEnumerateRequest final {
  public:
    std::optional<bool> includeValues     SWIFT_PRIVATE;
  ...
  public:
    SensitiveInfoEnumerateRequest() = default;
    explicit SensitiveInfoEnumerateRequest(std::optional<bool> includeValues, std::optional<std::string> service, std::optional<bool> iosSynchronizable, std::optional<std::string> keychainGroup, std::optional<AccessControl> accessControl, std::optional<AuthenticationPrompt> authenticationPrompt): includeValues(includeValues), service(service), iosSynchronizable(iosSynchronizable), keychainGroup(keychainGroup), accessControl(accessControl), authenticationPrompt(authenticationPrompt) {}

  public:
    friend bool operator==(const SensitiveInfoEnumerateRequest& lhs, const SensitiveInfoEnumerateRequest& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ SensitiveInfoEnumerateRequest <> JS SensitiveInfoEnumerateRequest (object)
  template <>
  struct JSIConverter<margelo::nitro::sensitiveinfo::SensitiveInfoEnumerateRequest> final {
    static inline margelo::nitro::sensitiveinfo::SensitiveInfoEnumerateRequest fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::sensitiveinfo::SensitiveInfoEnumerateRequest(
        JSIConverter<std::optional<bool>>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "includeValues"))),
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::sensitiveinfo::SensitiveInfoEnumerateRequest& arg) {
      jsi::Object obj(runtime);
      obj.setProperty(runtime, PropNameIDCache::get(runtime, "includeValues"), JSIConverter<std::optional<bool>>::toJSI(runtime, arg.includeValues));
    ...
    static inline bool canConvert(jsi::Runtime& runtime, const jsi::Value& value) {
      ...
      if (!JSIConverter<std::optional<bool>>::canConvert(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "includeValues")))) return false;
