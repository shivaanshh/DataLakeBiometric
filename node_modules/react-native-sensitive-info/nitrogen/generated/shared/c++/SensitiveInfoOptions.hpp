...
namespace margelo::nitro::sensitiveinfo {
  ...
  /**
   * A struct which can be represented as a JavaScript object (SensitiveInfoOptions).
   */
  struct SensitiveInfoOptions final {
  public:
  ...
  public:
    SensitiveInfoOptions() = default;
    explicit SensitiveInfoOptions(std::optional<std::string> service, std::optional<bool> iosSynchronizable, std::optional<std::string> keychainGroup, std::optional<AccessControl> accessControl, std::optional<AuthenticationPrompt> authenticationPrompt): service(service), iosSynchronizable(iosSynchronizable), keychainGroup(keychainGroup), accessControl(accessControl), authenticationPrompt(authenticationPrompt) {}

  public:
    friend bool operator==(const SensitiveInfoOptions& lhs, const SensitiveInfoOptions& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ SensitiveInfoOptions <> JS SensitiveInfoOptions (object)
  template <>
  struct JSIConverter<margelo::nitro::sensitiveinfo::SensitiveInfoOptions> final {
    static inline margelo::nitro::sensitiveinfo::SensitiveInfoOptions fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::sensitiveinfo::SensitiveInfoOptions(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::sensitiveinfo::SensitiveInfoOptions& arg) {
