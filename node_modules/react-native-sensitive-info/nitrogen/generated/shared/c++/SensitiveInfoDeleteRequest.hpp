///
/// SensitiveInfoDeleteRequest.hpp
...
namespace margelo::nitro::sensitiveinfo {
  ...
  /**
   * A struct which can be represented as a JavaScript object (SensitiveInfoDeleteRequest).
   */
  struct SensitiveInfoDeleteRequest final {
  public:
  ...
  public:
    SensitiveInfoDeleteRequest() = default;
    explicit SensitiveInfoDeleteRequest(std::string key, std::optional<std::string> service, std::optional<bool> iosSynchronizable, std::optional<std::string> keychainGroup, std::optional<AccessControl> accessControl, std::optional<AuthenticationPrompt> authenticationPrompt): key(key), service(service), iosSynchronizable(iosSynchronizable), keychainGroup(keychainGroup), accessControl(accessControl), authenticationPrompt(authenticationPrompt) {}

  public:
    friend bool operator==(const SensitiveInfoDeleteRequest& lhs, const SensitiveInfoDeleteRequest& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ SensitiveInfoDeleteRequest <> JS SensitiveInfoDeleteRequest (object)
  template <>
  struct JSIConverter<margelo::nitro::sensitiveinfo::SensitiveInfoDeleteRequest> final {
    static inline margelo::nitro::sensitiveinfo::SensitiveInfoDeleteRequest fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::sensitiveinfo::SensitiveInfoDeleteRequest(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::sensitiveinfo::SensitiveInfoDeleteRequest& arg) {
