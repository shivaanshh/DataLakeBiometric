///
/// Variant_NullType_SensitiveInfoItem.swift
 ...
 */
@frozen
public indirect enum Variant_NullType_SensitiveInfoItem {
  case first(NullType)
  case second(SensitiveInfoItem)
}

public extension Variant_NullType_SensitiveInfoItem {
